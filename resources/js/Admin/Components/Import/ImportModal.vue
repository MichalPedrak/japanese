<template>
    ...
    <form @submit.prevent class="max-w-2xl mx-auto import-form">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <select v-model="form.group_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <button @click="store.importCards(form)" v-if="store.showModal == 'import-cards'" type="submit" class="text-white bg-primary hover:bg-primary-hover  font-medium rounded-lg text-sm px-5 py-2.5 mr-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Importuj</button>
